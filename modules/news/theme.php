 ...
 * @return
 */
function topic_theme($topic_array, $topic_other_array, $generate_page, $page_title,$title,$bodytext,$ratename,$ratenumber, $description, $topic_image)
{
    ...
    $xtpl->assign('LANG', $lang_module);
    $xtpl->assign('TOPPIC_TITLE', $title);    

	$xtpl->assign('TOPPIC_BODYTEXT', $bodytext);
    $xtpl->assign('IMGWIDTH1', $module_config[$module_name]['homewidth']);
    if (! empty($description)) {
        ...
        $xtpl->parse('main.topicdescription.rate');
    }
