...
if (!empty($list)) {
    foreach ($list as $l) {
        ...
        $global_array_cat[$l['catid']]['link'] = NV_BASE_SITEURL . 'index.php?' . NV_LANG_VARIABLE . '=' . NV_LANG_DATA . '&amp;' . NV_NAME_VARIABLE . '=' . $l['alias'];
        $global_array_cat[$l['catid']]['rewrite_link'] = NV_BASE_SITEURL . 'index.php?' . NV_LANG_VARIABLE . '=' . NV_LANG_DATA . '&amp;' . NV_NAME_VARIABLE . '=' . $module_name;
...
// NẾU KHÔNG PHẢI LÀ LINK ĐÃ RÚT GỌN
if($link_true)
{
$page = 1;
