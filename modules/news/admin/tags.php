...
{
    global $db_slave, $lang_module, $lang_global, $module_name, $module_data, $op, $module_file, $global_config, $module_info, $module_config, $nv_Request, $db;
    ...
    while ($row = $sth->fetch()) {
		...
		$row['numnews'] = $db->query('SELECT COUNT(id) FROM ' . NV_PREFIXLANG . '_' . $module_data . '_tags_id WHERE tid ='. $row['tid'])->fetchColumn();
