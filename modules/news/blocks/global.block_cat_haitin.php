...
if (! nv_function_exists('nv_block_cat_haitin')) {
    function nv_block_config_cat_haitin($module, $data_block, $lang_block)
    {
    ...
    function nv_block_config_cat_haitin_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = array();
        $return['error'] = array();
    ...
    function nv_block_cat_haitin($block_config)
    {
...
if (defined('NV_SYSTEM')) {
    ...
    if (isset($site_mods[$module])) {
        ...
        $content = nv_block_cat_haitin($block_config);
    }
}
