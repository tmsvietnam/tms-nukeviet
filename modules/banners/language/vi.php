...
$lang_module['add_banner'] = 'Gửi đề nghị Quảng cáo mới';
...
$lang_module['addads_adsdata'] = 'File hình';
$lang_module['addads_description'] = 'Chú thích cho hình';
$lang_module['addads_url'] = 'Url khi click vào hình';
...
$lang_module['login_to_check'] = 'Hãy đăng nhập thành viên để kiểm tra quyền đăng quảng cáo. Nhấp vào đây để đăng nhập';
$lang_module['no_permission'] = 'Bạn không có quyền đăng quảng cáo. Hãy liên hệ với quản trị site để được cấp quyền đăng quảng cáo';
