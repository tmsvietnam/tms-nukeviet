...
$lang_translator['author'] = '<contact@thuongmaiso.vn>';
...
$lang_module['banners_list'] = 'Advertising';
$lang_module['title'] = 'Title';
$lang_module['title_empty'] = 'Title is empty';
$lang_module['size_incorrect'] = 'Size of block advertising is 50x50px';
$lang_module['add_plan_info'] = 'To create new blokc, you must enter fully box below';
$lang_module['edit_plan_info'] = 'Box marked with an asterisk to be required to declare';
$lang_module['width'] = 'Width';
$lang_module['height'] = 'Height';
$lang_module['blang'] = 'Language';
$lang_module['blang_all'] = 'All language';
$lang_module['size'] = 'Size advertising';
$lang_module['description'] = 'Description block';
$lang_module['edit_plan'] = 'Edit block advertising';
...
$lang_module['click_url'] = 'Banner\'s URL';
$lang_module['add_date'] = 'Initial';
$lang_module['publ_date'] = 'Start';
$lang_module['exp_date'] = 'Finish';
...
$lang_module['info_banner_caption'] = 'Advertising detail &ldquo;<strong>%s</strong>&rdquo;';
